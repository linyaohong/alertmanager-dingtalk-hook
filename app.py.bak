...
def send_alert(data):
    ...
    url = 'https://oapi.dingtalk.com/robot/send?access_token=c1213dff58f6e001ca801dab7d59bfd11a8b9&timestamp=1579252849336&sign=OznWGlI%2B2aws6Vgpna9t0r8IBdcxNh6ZjCB8GEzKwAk%3D'
    print(data)
    alerts = data['alerts']
    #print(alerts)
